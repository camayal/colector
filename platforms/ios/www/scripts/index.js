...
(function () {
    ...
    */
    ...
    function setScreen(inScreen) {
        ...
        //TODOOOOOOOOOOOOOOOOOOO VERIFICAR QUE OTRA MANERA DE HACER ESTO, CAUSA PROBLEMA CON LOS SEUDOCONTAINERS Y TAMBIEN CON LETREROS DE BACK.
        inMain =
        inRegistration =
        inReview =
        inConfig =
    ...
    function searchLocation() {
        ...
        if (document.getElementById('Latitude').value && document.getElementById('Longitude').value) {
            ...
            requestGM.open("GET", "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + encodeURI(document.getElementById('Latitude').value) + ',' + encodeURI(document.getElementById('Longitude').value) + '&key=AIzaSyDgQNFfUVstkAZokFgKDpuJq76mUdcBABs', true); //+'&key=AIzaSyDgQNFfUVstkAZokFgKDpuJq76mUdcBABs'
            requestGM.onreadystatechange = function () {
                ...
                if (requestGM.readyState == 4) {
                    ...
                    if (requestGM.status == 200 || requestGM.status == 0) {
                        ...
                        requestNT.open("GET", "http://api.geonames.org/findNearbyPlaceNameJSON?lat=" + encodeURI(document.getElementById('Latitude').value) + '&lng=' + encodeURI(document.getElementById('Longitude').value) + '&username=camayal&radius=10', true);
